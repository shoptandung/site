...
//  ĐÃ FIX LỖI DUYỆT TIỀN + ĐỒNG BỘ ĐA THIẾT BỊ
// ====================================================
...
// ====================================================
//  API CONFIG - THAY ĐỔI KHI CÓ BACKEND
// ====================================================
const API_BASE_URL = 'http://localhost:3000/api'; // Backend local
// const API_BASE_URL = 'https://your-domain.com/api'; // Khi deploy
...
// ====================================================
//  FILE DATA - LƯU TRONG LOCALSTORAGE
// ====================================================
function getGlobalFiles() {
    ...
    const defaultFiles = [
        { 
            id: 1, name: 'Reg Headshot V9 Max', category: 'reg', price: 50000, 
            badge: 'Hot', sold: 340, rating: 4.9,
            img: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=400',
            note: '🔧 Hướng dẫn: Tải file về, giải nén và copy vào thư mục game.',
            date: '2024-01-15',
            downloadLink: 'https://example.com/download/reg-headshot-v9.zip'
        },
        { 
            id: 2, name: 'Menu FF OBB V12.5', category: 'menu', price: 100000, 
            badge: 'VIP', sold: 290, rating: 4.8,
            img: 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=400',
            note: '📱 Menu OBB cài đặt đơn giản, copy vào thư mục Android/obb.',
            date: '2024-01-20',
            downloadLink: 'https://example.com/download/menu-obb-v12.5.zip'
        },
        { 
            id: 3, name: 'Config M1014 Long Tộc', category: 'config', price: 30000, 
            badge: 'New', sold: 210, rating: 4.9,
            img: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=400',
            note: '⚡ Config M1014 bá đạo, bắn 1 phát ăn ngay.',
            date: '2024-01-25',
            downloadLink: 'https://example.com/download/config-m1014.zip'
        },
        { 
            id: 4, name: 'Bypass Giả Lập PC Pro', category: 'bypass', price: 150000, 
            badge: 'Pro', sold: 180, rating: 4.9,
            img: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=400',
            note: '🖥️ Bypass giả lập PC, chạy mượt như điện thoại.',
            date: '2024-02-01',
            downloadLink: 'https://example.com/download/bypass-pc-pro.zip'
        },
        { 
            id: 5, name: 'Reg Headshot Auto Aim', category: 'reg', price: 45000, 
            badge: 'Sale', sold: 410, rating: 4.7,
            img: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=400',
            note: '🎯 Auto aim headshot, khóa mục tiêu cực nhanh.',
            date: '2024-02-05',
            downloadLink: 'https://example.com/download/reg-auto-aim.zip'
        },
        { 
            id: 6, name: 'Config XM8 Siêu Phẩm', category: 'config', price: 35000, 
            badge: 'Hot', sold: 260, rating: 4.8,
            img: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=400',
            note: '🔥 Config XM8 không giật, không bay, ổn định.',
            date: '2024-02-10',
            downloadLink: 'https://example.com/download/config-xm8.zip'
        },
        { 
            id: 7, name: 'Menu OBB V11.0 Lite', category: 'menu', price: 80000, 
            badge: 'Free', sold: 520, rating: 4.6,
            img: 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=400',
            note: '📦 Menu lite miễn phí, đủ dùng.',
            date: '2024-02-15',
            downloadLink: 'https://example.com/download/menu-obb-lite.zip'
        },
        { 
            id: 8, name: 'Tool Bypass AntiBan', category: 'bypass', price: 200000, 
            badge: 'Ultra', sold: 95, rating: 4.9,
            img: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=400',
            note: '🛡️ Tool chống ban cao cấp, bảo vệ acc tuyệt đối.',
            date: '2024-02-20',
            downloadLink: 'https://example.com/download/bypass-antiban.zip'
        },
        { 
            id: 9, name: 'Config Súng Ngắm Bắn Tỉa', category: 'config', price: 25000, 
            badge: 'New', sold: 150, rating: 4.5,
            img: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=400',
            note: '🔭 Config cho súng bắn tỉa, ngắm chuẩn, bắn dính.',
            date: '2024-02-25',
            downloadLink: 'https://example.com/download/config-sniper.zip'
        },
        { 
            id: 10, name: 'Reg Headshot Fast Scan', category: 'reg', price: 55000, 
            badge: 'VIP', sold: 320, rating: 4.8,
            img: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=400',
            note: '⚡ Fast scan headshot, tốc độ ánh sáng.',
            date: '2024-03-01',
            downloadLink: 'https://example.com/download/reg-fast-scan.zip'
        },
        { 
            id: 11, name: 'Config AK47 Bá Đạo', category: 'config', price: 40000, 
            badge: 'Hot', sold: 190, rating: 4.7,
            img: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=400',
            note: '💥 Config AK47 bá đạo, bắn là trúng.',
            date: '2024-03-05',
            downloadLink: 'https://example.com/download/config-ak47.zip'
        },
        { 
            id: 12, name: 'Menu OBB V13.0 Pro', category: 'menu', price: 120000, 
            badge: 'VIP', sold: 150, rating: 4.9,
            img: 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=400',
            note: '🎮 Menu OBB V13.0 Pro full tính năng, chống khóa mới nhất.',
            date: '2024-03-10',
            downloadLink: 'https://example.com/download/menu-obb-v13.zip'
        },
    ];
...
// ====================================================
//  ĐỒNG BỘ DỮ LIỆU GIỮA CÁC TAB/WINDOW & THIẾT BỊ
// ====================================================
...
try {
    ...
    syncChannel.onmessage = function(e) {
        if (e.data && e.data.type === 'sync') {
            console.log('🔄 Đồng bộ từ tab khác:', e.data);
            // Reload dữ liệu
            if (APP.isAdmin) {
                setTimeout(() => {
                    renderDepositRequests();
                    renderAdminDashboard();
                    showToast('📢 Có yêu cầu nạp mới từ thiết bị khác!', 'fas fa-bell', 'warning');
                }, 300);
            }
            if (APP.isLoggedIn) {
                ...
                if (updatedUser) {
                    ...
                    if (oldBalance !== APP.balance) {
                        showToast(`💰 Số dư đã cập nhật: ${APP.balance.toLocaleString()}đ`, 'fas fa-wallet', 'success');
                        triggerConfetti();
                    }
                    renderHistory();
    ...
    console.log('Broadcast Channel không hỗ trợ');
}
...
window.addEventListener('storage', function(e) {
    if (e.key === STORAGE_KEY_USERS) {
        console.log('📢 Phát hiện thay đổi user từ tab khác');
        if (APP.isAdmin) {
            setTimeout(() => {
                renderDepositRequests();
                renderAdminDashboard();
                showToast('📢 Có yêu cầu nạp mới!', 'fas fa-bell', 'warning');
            }, 300);
        }
        if (APP.isLoggedIn) {
            const updatedUser = Auth.getUserById(APP.currentUser.id);
    ...
    if (e.key === STORAGE_KEY_SPIN_WEIGHTS) {
        if (APP.isAdmin && typeof renderAdminSpinWeights === 'function') renderAdminSpinWeights();
    }
    if (e.key === 'ff_sync_trigger') {
        console.log('🔄 Sync trigger từ tab khác');
        if (APP.isAdmin) {
            setTimeout(() => {
                renderDepositRequests();
                renderAdminDashboard();
        ...
        if (APP.isLoggedIn) {
            const updatedUser = Auth.getUserById(APP.currentUser.id);
            if (updatedUser && updatedUser.balance !== APP.balance) {
                APP.balance = updatedUser.balance;
                APP.history = updatedUser.history;
                APP.totalDeposit = updatedUser.totalDeposit;
                APP.vipLevel = updatedUser.vipLevel;
                APP.vipPoints = updatedUser.vipPoints;
                if (DOM.userBalance) DOM.userBalance.textContent = APP.balance.toLocaleString();
                if (DOM.profileBalance) DOM.profileBalance.textContent = APP.balance.toLocaleString() + 'đ';
                renderHistory();
                updateVIPUI(updatedUser);
                showToast(`💰 Số dư đã được cập nhật!`, 'fas fa-wallet', 'success');
            }
        }
    }
});

// ---- POLLING - KIỂM TRA DỮ LIỆU MỚI ĐỊNH KỲ ----
let lastPollCheck = 0;

function pollForUpdates() {
    const now = Date.now();
    if (now - lastPollCheck < 3000) return;
    lastPollCheck = now;
    
    const trigger = localStorage.getItem('ff_sync_trigger');
    if (trigger && parseInt(trigger) > now - 5000) {
        if (APP.isAdmin) {
            renderDepositRequests();
            renderAdminDashboard();
        }
        if (APP.isLoggedIn) {
            ...
            if (updatedUser && updatedUser.balance !== APP.balance) {
                ...
                renderHistory();
                updateVIPUI(updatedUser);
                showToast(`💰 Số dư đã được cập nhật: ${APP.balance.toLocaleString()}đ`, 'fas fa-wallet', 'success');
            }
        }
    }
}
...
function renderCart() {
    ...
    if (cart.length === 0) {
        container.innerHTML = `
            <div class="cart-empty">
                ...
                <button class="btn-submit" style="width:auto;padding:10px 30px;margin-top:10px;" onclick="switchTab('filesTab')">
    ...
    container.innerHTML = `
        <div style="margin-bottom:16px;">
            ${cart.map(item => `
                <div class="cart-item">
                    <img src="${item.img || 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=100'}" alt="${item.name}">
                    <div class="info">
                        <div class="name">${item.name}</div>
                        <div class="price">${item.price.toLocaleString()}đ</div>
                    </div>
                    <button class="btn-remove" onclick="removeFromCart(${item.id})"><i class="fas fa-times"></i> Xóa</button>
                </div>
            `).join('')}
        </div>
        <div class="cart-summary">
            <div>
                <div style="font-size:14px;color:var(--text-muted);">
                    ...
                    ${hasDiscount ? `<span style="color:#ffd700;font-size:12px;margin-left:8px;">(-${discount}% VIP)</span>` : ''}
                </div>
                <div class="total">${finalTotal.toLocaleString()}đ</div>
            </div>
            <div style="display:flex;gap:10px;flex-wrap:wrap;">
                <button class="btn-submit" style="width:auto;padding:10px 20px;background:#ff4d4d;box-shadow:none;" onclick="clearCart()">
...
function checkoutCart() {
    if (!Auth.isLoggedIn()) {
        showToast('Vui lòng đăng nhập!', 'fas fa-triangle-exclamation', 'error');
        openModal('loginModal');
        return;
    }
    if (APP.isAdmin) {
        showToast('Admin không cần mua hàng!', 'fas fa-wrench', 'warning');
        return;
    }
    const cart = getCart();
    if (cart.length === 0) {
        showToast('Giỏ hàng trống!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    ...
    if (APP.balance < finalTotal) {
        showToast('Số dư không đủ! Vui lòng nạp thêm.', 'fas fa-wallet', 'error');
...
function processCheckout(purchased, finalTotal, discount) {
    if (purchased.length === 0) {
        showToast('Không có file để mua!', 'fas fa-info-circle', 'warning');
        return;
    }
    
    const user = Auth.updateBalance(APP.currentUser.id, -finalTotal, 
        `Mua ${purchased.length} file${discount > 0 ? ` (giảm ${discount}% VIP)` : ''}`);
    if (!user) {
        showToast('Lỗi khi thanh toán!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
...
// ====================================================
//  MUA NGAY - THANH TOÁN TRỰC TIẾP KHÔNG QUA GIỎ
// ====================================================
function buyNow(fileId) {
    if (!Auth.isLoggedIn()) {
        showToast('Vui lòng đăng nhập để mua!', 'fas fa-triangle-exclamation', 'error');
        openModal('loginModal');
        return;
    }
    if (APP.isAdmin) {
    ...
    Swal.fire({
        ...
        if (res.isConfirmed) {
            const user = Auth.updateBalance(APP.currentUser.id, -finalPrice, 
                `Mua ngay: ${file.name}${discount > 0 ? ` (giảm ${discount}% VIP)` : ''}`);
            if (!user) {
                showToast('Lỗi khi thanh toán!', 'fas fa-triangle-exclamation', 'error');
                return;
            }
...
const Auth = {
    ...
    getCurrentUser() {
        try { return JSON.parse(localStorage.getItem(STORAGE_KEY_CURRENT_USER)) || null; } 
        catch { return null; }
    },
    ...
    calculateVipLevel(totalDeposit) {
        ...
        for (let i = VIP_CONFIG.length - 1; i >= 0; i--) {
            if (totalDeposit >= VIP_CONFIG[i].minDeposit) {
                level = i;
                break;
            }
        }
    ...
    // ===== SỬA LẠI CREATE DEPOSIT REQUEST - GỬI TÍN HIỆU ĐỒNG BỘ =====
    createDepositRequest(userId, amount, method) {
        ...
        // GỬI TÍN HIỆU ĐỒNG BỘ
        broadcastSync();
        syncDataToServer('users', users);
        
        // Thông báo cho admin nếu đang đăng nhập
        if (APP.isAdmin) {
            setTimeout(() => {
                renderDepositRequests();
                renderAdminDashboard();
    ...
    // ===== SỬA LẠI APPROVE DEPOSIT - FIX LỖI KHÔNG NHẬN TIỀN =====
    approveDeposit(requestId) {
        ...
        foundUser.balance = oldBalance + foundRequest.amount;
        foundUser.totalDeposit = (foundUser.totalDeposit || 0) + foundRequest.amount;
        ...
        foundUser.history.unshift({
            ...
            amount: `+${foundRequest.amount.toLocaleString()}đ`,
            status: 'Thành công',
            time: new Date().toLocaleString('vi-VN')
        });
        ...
        // GỬI TÍN HIỆU ĐỒNG BỘ CHO TẤT CẢ THIẾT BỊ
        broadcastSync();
        syncDataToServer('users', users);
        ...
        // Cập nhật UI admin
        if (typeof renderDepositRequests === 'function') {
            setTimeout(renderDepositRequests, 200);
        }
        if (typeof renderAdminDashboard === 'function') {
            setTimeout(renderAdminDashboard, 300);
        }
        if (typeof updateRealStats === 'function') {
            setTimeout(updateRealStats, 400);
        }
        
        showToast(`✅ Đã duyệt ${foundRequest.amount.toLocaleString()}đ cho ${foundUser.username}!`, 'fas fa-check-circle', 'success');
        triggerConfetti();
    ...
    addReview(userId, username, fileId, fileName, rating, content, images) {
        ...
        const avgRating = fileReviews.length > 0 
            ? fileReviews.reduce((sum, r) => sum + r.rating, 0) / fileReviews.length 
            : 0;
        const file = FILE_DATA.find(f => f.id === fileId);
        if (file) {
            file.rating = Math.round(avgRating * 10) / 10;
            file.sold = fileReviews.length;
    ...
    getRealStats() {
        const users = this.getUsers();
        const reviews = this.getReviews();
        let totalSold = 0, totalRevenue = 0, totalReviews = reviews.length;
        let reviewSum = 0;
        ...
        reviews.forEach(r => reviewSum += r.rating);
        ...
        return { totalSold, totalRevenue, totalReviews, avgRating, topDepositor: topName, topAmount };
    },
    
    getAdminStats() {
        const users = this.getUsers();
        const reviews = this.getReviews();
        let totalUsers = 0, totalBalance = 0, pendingDeposits = 0;
        let todayRevenue = 0, vipUsers = 0;
            ...
            if (user.history) {
                user.history.forEach(h => {
                    if (new Date(h.time).toDateString() === today) {
                        const num = parseInt(h.amount.replace(/[^0-9]/g, ''));
                        if (h.amount.startsWith('+')) todayRevenue += num;
                    }
                });
            }
        });
    ...
    getDailyStats(days = 30) {
        ...
        for (let i = days - 1; i >= 0; i--) {
            ...
            dailyData[key] = { orders: 0, revenue: 0, deposits: 0 };
        }
        users.forEach(user => {
            if (user.history) {
                user.history.forEach(h => {
                    const dateKey = new Date(h.time).toISOString().split('T')[0];
                    if (dailyData[dateKey]) {
                        dailyData[dateKey].orders++;
                        const num = parseInt(h.amount.replace(/[^0-9]/g, ''));
                        if (h.amount.startsWith('+')) {
                            dailyData[dateKey].revenue += num;
                            dailyData[dateKey].deposits++;
                        }
                    }
                });
            }
    ...
    getGiftcodes() {
        try { return JSON.parse(localStorage.getItem(STORAGE_KEY_GIFTCODES)) || []; } 
        catch { return []; }
    },
    saveGiftcodes(codes) {
    ...
    getEvents() {
        try { return JSON.parse(localStorage.getItem(STORAGE_KEY_EVENTS)) || EVENTS; } 
        catch { return EVENTS; }
    },
    saveEvents(events) {
...
function getBankConfig() {
    try {
        ...
        if (stored) {
            ...
            return {
                Momo: { ...DEFAULT_BANK_CONFIG.Momo, ...parsed.Momo },
                MBBank: { ...DEFAULT_BANK_CONFIG.MBBank, ...parsed.MBBank }
            };
        }
    } catch (e) {}
...
function renderAdminQRConfig() {
    ...
    if (momoPreview && momo.qrImage) {
        momoPreview.innerHTML = `<img src="${momo.qrImage}" style="width:100%;border-radius:8px;border:1px solid rgba(255,255,255,0.1);">`;
    }
    if (mbPreview && mbbank.qrImage) {
        mbPreview.innerHTML = `<img src="${mbbank.qrImage}" style="width:100%;border-radius:8px;border:1px solid rgba(255,255,255,0.1);">`;
    }
}
...
function adminSaveQRConfig() {
    ...
    Promise.all([
        ...
        config.Momo = {
            ...config.Momo,
            account: document.getElementById('adminMomoAccount').value.trim(),
            accountName: document.getElementById('adminMomoName').value.trim(),
            qrImage: momoQR || config.Momo.qrImage || ''
        };
        config.MBBank = {
            ...config.MBBank,
            account: document.getElementById('adminMBBankAccount').value.trim(),
            accountName: document.getElementById('adminMBBankName').value.trim(),
            qrImage: mbQR || config.MBBank.qrImage || ''
        };
...
// ====================================================
//  DEPOSIT - SỬ DỤNG QR ẢNH ĐÃ UPLOAD
// ====================================================
...
const DOM = {
    ...
    adminChartPeriod: document.getElementById('adminChartPeriod'),
...
// ====================================================
//  HÀM ĐỒNG BỘ LÊN SERVER (KHI CÓ BACKEND)
// ====================================================
function syncDataToServer(dataType, data) {
    ...
    .then(result => {
        if (result.success) {
            console.log(`✅ Đã đồng bộ ${dataType} lên server`);
        }
    })
...
function fetchDataFromServer() {
    console.log('[FETCH] Đang lấy dữ liệu từ server...');
    // === UNCOMMENT KHI CÓ BACKEND ===
    /*
    fetch(`${API_BASE_URL}/sync`)
        .then(res => res.json())
        .then(result => {
            ...
            if (data.files) {
                localStorage.setItem(STORAGE_KEY_FILES, JSON.stringify(data.files));
                FILE_DATA = getGlobalFiles();
                APP.files = [...FILE_DATA];
                APP.filteredFiles = [...FILE_DATA];
                renderFiles();
            ...
            if (data.bank) {
                localStorage.setItem(STORAGE_KEY_BANK, JSON.stringify(data.bank));
                APP.bankConfig = getBankConfig();
                if (APP.isAdmin) renderAdminQRConfig();
            }
            if (data.support) {
                localStorage.setItem(STORAGE_KEY_SUPPORT, JSON.stringify(data.support));
                updateSupportUI(getSupportLinks());
            }
            if (data.spinWeights) {
                localStorage.setItem(STORAGE_KEY_SPIN_WEIGHTS, JSON.stringify(data.spinWeights));
            }
            showToast('🔄 Dữ liệu đã được đồng bộ từ server!', 'fas fa-sync', 'success');
        })
        .catch(err => console.error('Fetch error:', err));
    */
}

// Gọi fetchDataFromServer định kỳ (30 giây)
setInterval(fetchDataFromServer, 30000);

// Gọi fetchDataFromServer khi load trang
setTimeout(fetchDataFromServer, 2000);

// ====================================================
//  SECURITY - ANTI-DEBUG + ANTI-F12 + ANTI-DDOS
// ====================================================
function securityLog(message) {
    const logContainer = DOM.securityLog;
    ...
    document.addEventListener('keydown', function(e) {
        ...
        for (let combo of blockedCombos) {
            if ((!combo.ctrl || e.ctrlKey) && (!combo.shift || e.shiftKey) && 
                (e.key === combo.key || e.keyCode === combo.code || e.keyCode === combo.key?.charCodeAt(0))) {
                e.preventDefault();
                e.stopPropagation();
...
(function antiDebugPro() {
    ...
    window.console = new Proxy(originalConsole, {
        get: function(target, prop) {
            if (['log', 'warn', 'error', 'info', 'debug', 'clear'].includes(prop)) {
                return function() {};
            }
            return target[prop];
        }
    ...
    window.eval = function(code) {
        if (code && code.includes('debugger')) {
            securityLog('⚠️ Phát hiện debugger statement - Đã chặn');
            return null;
        }
    ...
    window.Function = function(...args) {
        if (args.some(arg => arg && arg.includes('debugger'))) {
            securityLog('⚠️ Phát hiện Function constructor attack - Đã chặn');
            return function() {};
        }
...
(function antiXSSPro() {
    ...
    for (let [key, value] of params) {
        ...
        if (sanitized !== value) {
            ...
            securityLog('🚨 Phát hiện XSS trong URL - Đã chặn');
            showToast('🚫 Phát hiện tấn công XSS!', 'fas fa-shield-halved', 'error');
            break;
        }
    }
})();
...
// ---- CHỐNG CLICKJACKING ----
(function preventClickjackingPro() {
    if (window.top !== window.self) {
        window.top.location = window.self.location;
        securityLog('🚨 Phát hiện Clickjacking - Đã chặn');
    }
    document.querySelectorAll('iframe').forEach(iframe => iframe.remove());
    Object.defineProperty(document, 'referrer', { get: function() { return ''; } });
})();

// ---- ANTI-DDOS - ĐÃ VÔ HIỆU HÓA CHẶN IP ----
(function antiDDoSPro() {
    let requestLog = [];
    setInterval(() => {
        securityLog('📊 Request log: ' + requestLog.length + ' requests');
        requestLog = [];
    }, 60000);
    function checkRateLimit(ip = 'default') {
        requestLog.push({ ip, time: Date.now() });
        return true;
    }
    function isIPBlocked(ip = 'default') {
        return false;
    }
    ['click', 'keydown', 'submit', 'touchstart', 'scroll'].forEach(eventType => {
        document.addEventListener(eventType, function(e) {
            if (!checkRateLimit()) {
                securityLog('⚠️ Rate limit warning (không chặn)');
            }
...
function getSupportLinks() {
    try {
        return JSON.parse(localStorage.getItem(STORAGE_KEY_SUPPORT)) || {
            zalo: '0358888888',
            facebook: 'Tấn Dũng FF',
            telegram: '@TandungFF'
        };
    } catch { 
        return { zalo: '0358888888', facebook: 'Tấn Dũng FF', telegram: '@TandungFF' };
    }
}
...
function adminSaveSupport(e) {
    e.preventDefault();
    const data = {
        zalo: document.getElementById('adminZaloInput').value.trim(),
        facebook: document.getElementById('adminFbInput').value.trim(),
        telegram: document.getElementById('adminTelegramInput').value.trim()
    };
...
function getSpinWeights() {
    try {
        return JSON.parse(localStorage.getItem(STORAGE_KEY_SPIN_WEIGHTS)) || SPIN_PRIZES.map(() => 1);
    } catch { return SPIN_PRIZES.map(() => 1); }
}
...
function renderAdminSpinWeights() {
    const container = document.getElementById('adminSpinWeights');
    if (!container) return;
    ...
    container.innerHTML = SPIN_PRIZES.map((prize, i) => {
        ...
        return `
            <div class="spin-weight-item">
                <span class="prize-icon">${prize.icon}</span>
                <span class="prize-name">${prize.name}</span>
                <input type="number" id="spinWeight_${i}" value="${weights[i] || 1}" min="0" max="100" step="0.5" onchange="updateSpinWeightPercent(${i})">
                <span class="weight-percent" id="spinWeightPercent_${i}">${percent}%</span>
            </div>
        `;
    }).join('');
}
...
function updateSpinWeightPercent(index) {
    ...
    const total = weights.reduce((a, b) => a + b, 0);
    SPIN_PRIZES.forEach((_, i) => {
        const pct = document.getElementById(`spinWeightPercent_${i}`);
        if (pct) {
            pct.textContent = total > 0 ? ((weights[i] || 0) / total * 100).toFixed(1) + '%' : '0%';
        }
    });
}
...
function updateAdminSpinStats() {
    ...
    users.forEach(u => {
        ...
        if (u.spinHistory) {
            u.spinHistory.forEach(h => {
                totalAmount += h.value || 0;
            });
        }
    });
...
function initSecurity() {
    ...
    securityLog('🟢 Chống Clickjacking đã kích hoạt');
    securityLog('🟢 Anti-DDoS đã được vô hiệu hóa (không chặn IP)');
    securityLog('🟢 Đồng bộ dữ liệu file giữa các user đã kích hoạt');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🚀 SHOP TẤN DŨNG FF v16.0 - Cart + QR Image System Loaded!');
    console.log('📁 Files:', FILE_DATA.length);
    console.log('🛒 Cart: Giỏ hàng đã sẵn sàng');
    console.log('🏦 QR: Ảnh QR code đã được hỗ trợ');
    console.log('🛡️ Security: Active (IP Block DISABLED)');
});
...
function updateClock() {
    const now = new Date();
    if (DOM.adminToday) {
        DOM.adminToday.textContent = now.toLocaleDateString('vi-VN', { 
            weekday: 'long', day: 'numeric', month: 'numeric', year: 'numeric' 
        });
    }
    if (DOM.adminTime) {
        DOM.adminTime.textContent = now.toLocaleTimeString('vi-VN');
    }
}
...
function loginSuccess(user) {
    ...
    DOM.profileVipBadge.style.background = APP.vipLevel > 0 
        ? `linear-gradient(135deg,${VIP_CONFIG[APP.vipLevel].color},${VIP_CONFIG[APP.vipLevel].color}dd)` 
        : 'linear-gradient(135deg,#94a3b8,#64748b)';
    
    const userReviews = Auth.getReviews().filter(r => r.userId === user.id);
    if (DOM.profileReviewCount) {
        DOM.profileReviewCount.textContent = userReviews.length;
    }
...
function updateVIPUI(user) {
    ...
    if (DOM.vipLevelBadge) {
        ...
        DOM.vipLevelBadge.style.background = level > 0 
    ...
    if (DOM.vipProgressText) {
        if (vipInfo.nextLevel) {
            DOM.vipProgressText.textContent = 
                `${(user.totalDeposit || 0).toLocaleString()}đ / ${vipInfo.nextLevel.minDeposit.toLocaleString()}đ để lên ${vipInfo.nextLevel.name}`;
        } else {
            DOM.vipProgressText.textContent = '🎉 Đã đạt cấp VIP cao nhất!';
        }
    }
    ...
    document.querySelectorAll('.vip-level-card').forEach(card => {
        ...
        card.classList.toggle('active', lv === level);
        if (lv === level) {
...
function handleRegisterSubmit(e) {
    ...
    if (!username || username.length < 3) {
        showToast('Tên đăng nhập tối thiểu 3 ký tự!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    if (!email || !email.includes('@')) {
        showToast('Email không hợp lệ!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    if (!password || password.length < 6) {
        showToast('Mật khẩu tối thiểu 6 ký tự!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    if (password !== confirm) {
...
document.addEventListener('click', function(e) {
    ...
    if (option) {
        ...
        APP.selectedMethod = option.dataset.method;
    }
});
...
function handleDepositSubmit(e) {
    ...
    if (APP.isAdmin) {
        showToast('Admin không cần nạp tiền!', 'fas fa-wrench', 'warning');
        return;
    }
    ...
    if (!amount || amount < 10000) {
        showToast('Số tiền tối thiểu 10.000đ!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    if (amount > APP.maxDeposit) {
        showToast(`Số tiền vượt quá giới hạn ${APP.maxDeposit.toLocaleString()}đ!`, 'fas fa-triangle-exclamation', 'error');
        return;
    }
    const user = Auth.getCurrentUser();
    const request = Auth.createDepositRequest(user.id, amount, method);
    if (!request) {
        showToast('Lỗi tạo yêu cầu!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    APP.pendingDeposit = request;
    const qrData = generateQR(amount, method);
    if (!qrData) {
        showToast('Lỗi tạo QR!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    ...
    DOM.qrImage.onerror = function() {
        ...
        document.querySelector('.qr-code-wrapper').innerHTML = `
            <div style="text-align:center;padding:30px;">
                <i class="fas fa-university" style="font-size:48px;color:var(--primary);display:block;margin-bottom:10px;"></i>
                <p style="color:var(--text-muted);font-size:13px;">
                    Chuyển khoản đến: <b style="color:var(--text-main);">${qrData.account}</b><br>
                    Ngân hàng: <b style="color:var(--text-main);">${qrData.bankName}</b><br>
                    Nội dung: <b style="color:var(--text-main);">${qrData.content}</b><br>
                    Số tiền: <b style="color:#ffaa00;">${qrData.amount.toLocaleString()}đ</b>
                </p>
            </div>
        `;
    };
...
function confirmPaid() {
    if (!APP.pendingDeposit) {
        showToast('Không tìm thấy yêu cầu!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
...
function handleDepositPage(e) {
    ...
    document.querySelectorAll('#amountPresets .preset-btn').forEach(btn => {
...
function updateDepositUsername() {
    const user = Auth.getCurrentUser();
    if (DOM.depositUsernameDisplay) {
        DOM.depositUsernameDisplay.textContent = user ? user.username : 'Chưa đăng nhập';
    }
    if (DOM.depositPageUsername) {
        DOM.depositPageUsername.textContent = user ? user.username : 'chưa đăng nhập';
    }
}

// ====================================================
//  PRESET BUTTONS & DEPOSIT LIMIT
// ====================================================
    ...
    document.querySelectorAll('.preset-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (parent) {
                ...
                if (input) {
                    if (amount > APP.maxDeposit) {
                        showToast('Số tiền vượt quá giới hạn 1.000.000đ!', 'fas fa-triangle-exclamation', 'error');
                        return;
                    }
                    input.value = amount;
                }
...
function setupDepositLimitCheck() {
    ...
    const pageAmountInput = document.getElementById('pageDepositAmount');
    if (pageAmountInput) {
        pageAmountInput.addEventListener('input', function() {
            const val = parseInt(this.value) || 0;
            if (val > APP.maxDeposit) {
                this.classList.add('error');
            } else {
...
function setupReviewImagePreview() {
    ...
    if (input) {
        input.addEventListener('change', function() {
            ...
            if (files.length > 3) {
                showToast('Chỉ được tối đa 3 ảnh!', 'fas fa-triangle-exclamation', 'error');
                this.value = '';
                return;
            }
            files.forEach(file => {
                if (!file.type.startsWith('image/')) {
                    showToast('Chỉ chấp nhận file ảnh!', 'fas fa-triangle-exclamation', 'error');
                    this.value = '';
                    return;
                }
                const reader = new FileReader();
...
function populateReviewFiles() {
    ...
    if (select) {
        select.innerHTML = '<option value="">Chọn file...</option>' +
            APP.files.map(f => `<option value="${f.id}">${f.name}</option>`).join('');
    }
    const filterSelect = document.getElementById('reviewFilterProduct');
    if (filterSelect) {
        filterSelect.innerHTML = '<option value="all">Tất cả file</option>' +
            APP.files.map(f => `<option value="${f.id}">${f.name}</option>`).join('');
    }
}
...
function openReviewModal() {
    if (!APP.isLoggedIn) {
        showToast('Vui lòng đăng nhập để đánh giá!', 'fas fa-triangle-exclamation', 'error');
        openModal('loginModal');
        return;
    }
    ...
    document.querySelectorAll('.star-rating i').forEach(s => {
        s.classList.toggle('active', parseInt(s.dataset.star) <= 5);
    });
...
function handleReviewSubmit(e) {
    ...
    if (!fileId) {
        showToast('Vui lòng chọn file!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    if (!content || content.length < 10) {
        showToast('Nội dung đánh giá tối thiểu 10 ký tự!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
...
function renderReviews() {
    ...
    if (filterFile !== 'all') {
        filtered = filtered.filter(r => r.fileId === parseInt(filterFile));
    }
    if (filterRating !== 'all') {
    ...
    if (filtered.length === 0) {
        container.innerHTML = `<div style="text-align:center;padding:40px;color:var(--text-muted);">
            <i class="fas fa-comment" style="font-size:32px;display:block;margin-bottom:12px;"></i>
        ...
        <div class="review-item">
            <div class="review-header">
                <div class="review-user">
                    <img src="${APP.currentUser?.id === r.userId ? (APP.currentUser.avatar || 'https://i.pravatar.cc/32?img=' + Math.floor(Math.random()*70)) : 'https://i.pravatar.cc/32?img=' + Math.floor(Math.random()*70)}" alt="${r.username}">
                    <span>${r.username}</span>
                    ${r.userId === APP.currentUser?.id ? '<span style="font-size:10px;color:var(--primary);">(Bạn)</span>' : ''}
                </div>
                <div class="review-stars">${'⭐'.repeat(r.rating)}${'☆'.repeat(5 - r.rating)}</div>
            </div>
            <div class="review-product">📦 ${r.fileName}</div>
            <div class="review-content">${r.content}</div>
            ${r.images && r.images.length > 0 ? `
                <div class="review-images">
                    ${r.images.map(img => `<img src="${img}" alt="Review image" onclick="window.open('${img}','_blank')">`).join('')}
                </div>
            ` : ''}
            <div class="review-time">${new Date(r.createdAt).toLocaleString('vi-VN')}</div>
        </div>
    `).join('');
}
...
function renderTopRanking(period = 'all') {
    ...
    if (!container) return;
    document.querySelectorAll('.top-filter .btn-filter').forEach(btn => {
        btn.classList.toggle('active', btn.dataset.period === period);
    });
    const topUsers = Auth.getTopDepositors(period);
    if (topUsers.length === 0) {
        container.innerHTML = `<div style="text-align:center;padding:40px;color:var(--text-muted);">
            <i class="fas fa-trophy" style="font-size:32px;display:block;margin-bottom:12px;"></i>
            Chưa có dữ liệu
        </div>`;
        return;
    }
    ...
    container.innerHTML = topUsers.slice(0, 20).map((user, index) => `
        <div class="top-item">
            <div class="rank ${index < 3 ? rankClasses[index] : 'normal'}">
                ${index < 3 ? medals[index] : `#${index + 1}`}
            </div>
            <img src="${user.avatar || 'https://i.pravatar.cc/40?img=' + (index + 10)}" alt="${user.username}" class="avatar">
            <div class="info">
                <div class="name">
                    ${user.username}
                    ${(user.vipLevel || 0) > 0 ? `<span class="vip-tag">👑 VIP ${user.vipLevel}</span>` : ''}
                </div>
                <div class="detail">${(user.history || []).filter(h => h.amount.startsWith('+')).length} giao dịch</div>
            </div>
            <div class="amount">${(user.totalDeposit || 0).toLocaleString()}đ</div>
        </div>
    `).join('');
}
...
function updateRealStats() {
    ...
    if (DOM.realTopDeposit) {
        DOM.realTopDeposit.textContent = stats.topDepositor !== 'Chưa có' 
            ? `${stats.topDepositor} (${stats.topAmount.toLocaleString()}đ)` 
            : 'Chưa có';
    }
}

// ====================================================
//  RENDER FILES - XÓA "ĐÃ MUA", LUÔN HIỂN THỊ NÚT MUA
// ====================================================
function renderFiles() {
    ...
    if (displayed.length === 0) {
        container.innerHTML = `<div style="text-align:center;padding:40px;color:var(--text-muted);">Không tìm thấy file.</div>`;
        return;
    }
    const discount = APP.isLoggedIn && !APP.isAdmin ? Auth.getDiscount(APP.currentUser.id) : 0;
    const cart = getCart();
    container.innerHTML = displayed.map(f => {
        ...
        <div class="product-card" data-id="${f.id}">
            <span class="product-badge">${f.badge || 'Hot'}</span>
            <div class="product-img-wrapper"><img src="${f.img}" class="product-img" alt="${f.name}" loading="lazy"></div>
            <div class="product-details">
                <div class="product-title">${f.name}</div>
                <div class="product-stats">
                    <span><i class="fas fa-shopping-cart"></i> <b>${f.sold}</b></span>
                    <div class="product-rating"><i class="fas fa-star"></i> ${f.rating || 0}</div>
                </div>
                ${APP.isLoggedIn ? `
                    <div class="protected-price-area" style="display:flex;flex-wrap:wrap;gap:8px;">
                        <div class="product-price" style="${hasDiscount ? 'color:#00ff88;font-size:20px;' : ''}">
                            ${finalPrice.toLocaleString()}đ
                            ${hasDiscount ? `<span style="font-size:11px;color:#ffd700;">(-${discount}% VIP)</span>` : ''}
                        </div>
                        <div style="display:flex;gap:6px;width:100%;">
                            <button class="btn-buy btn-buy-now" onclick="buyNow(${f.id})" style="flex:1;font-size:11px;padding:8px;">
                                <i class="fas fa-bolt"></i> Mua ngay
                            </button>
                            <button class="btn-buy" onclick="${inCart ? `showToast('Đã có trong giỏ hàng!', 'fas fa-info-circle', 'warning')` : `addToCart(${f.id})`}" 
                                style="flex:1;${inCart ? 'background:linear-gradient(135deg,#ffaa00,#ff6600);' : ''}font-size:11px;padding:8px;">
                                <i class="fas ${inCart ? 'fa-check' : 'fa-cart-plus'}"></i> ${inCart ? 'Đã thêm' : 'Thêm giỏ'}
                            </button>
                        </div>
                    </div>
                ` : `
                    <div class="login-required-msg" onclick="openModal('loginModal')"><i class="fas fa-lock"></i> Đăng nhập để mua</div>
                `}
            </div>
        </div>
    `}).join('');
    ...
    if (loadMoreBtn) {
        loadMoreBtn.style.display = files.length > displayed.length ? 'block' : 'none';
    }
...
function getFilteredFiles() {
    ...
    if (APP.currentCategory !== 'all') {
        files = files.filter(f => f.category === APP.currentCategory);
    }
    if (APP.searchQuery) {
...
function renderFileGrid() {
    ...
    if (pageFiles.length === 0) {
        container.innerHTML = `<div style="text-align:center;padding:40px;color:var(--text-muted);">Không tìm thấy file nào</div>`;
        return;
    }
    const cart = getCart();
    container.innerHTML = pageFiles.map(f => {
        ...
        <div class="product-card">
            <span class="product-badge" style="${f.price === 0 ? 'background:#00ff88;color:#000;' : ''}">${f.badge}</span>
            <div class="product-img-wrapper"><img src="${f.img}" class="product-img" loading="lazy"></div>
            <div class="product-details">
                <div class="product-title">${f.name}</div>
                <div class="product-stats">
                    <span><i class="fas fa-shopping-cart"></i> <b>${f.sold}</b></span>
                    <span><i class="fas fa-star" style="color:#ffaa00;"></i> ${f.rating}</span>
                </div>
                <div class="product-price" style="${f.price === 0 ? 'color:#00ff88;' : ''}">${f.price === 0 ? 'Miễn Phí' : f.price.toLocaleString() + 'đ'}</div>
                <div style="display:flex;gap:6px;width:100%;">
                    <button class="btn-buy btn-buy-now" onclick="${f.price === 0 ? `showToast('Đã tải file miễn phí!', 'fas fa-circle-check')` : `buyNow(${f.id})`}" 
                        style="flex:1;${f.price === 0 ? 'background:#00ff88;color:#000;' : ''}font-size:11px;padding:8px;">
                        <i class="fas fa-bolt"></i> ${f.price === 0 ? 'Tải ngay' : 'Mua ngay'}
                    </button>
                    <button class="btn-buy" onclick="${inCart ? `showToast('Đã có trong giỏ hàng!', 'fas fa-info-circle', 'warning')` : `addToCart(${f.id})`}" 
                        style="flex:1;${inCart ? 'background:linear-gradient(135deg,#ffaa00,#ff6600);' : ''}font-size:11px;padding:8px;">
                        <i class="fas ${inCart ? 'fa-check' : 'fa-cart-plus'}"></i> ${inCart ? 'Đã thêm' : 'Thêm giỏ'}
    ...
    if (DOM.filePageInfo) {
        DOM.filePageInfo.textContent = `Trang ${APP.currentFilePage} / ${totalPages || 1}`;
    }
}
...
function filterFiles() {
    ...
    APP.filteredFiles = [...FILE_DATA];
    if (search) {
        APP.filteredFiles = APP.filteredFiles.filter(f => f.name.toLowerCase().includes(search));
    }
    if (category !== 'all') {
        APP.filteredFiles = APP.filteredFiles.filter(f => f.category === category);
    }
    if (price === 'free') {
        APP.filteredFiles = APP.filteredFiles.filter(f => f.price === 0);
    } else if (price === 'under50') {
        APP.filteredFiles = APP.filteredFiles.filter(f => f.price > 0 && f.price < 50000);
    } else if (price === 'under100') {
        APP.filteredFiles = APP.filteredFiles.filter(f => f.price >= 50000 && f.price < 100000);
    } else if (price === 'under200') {
        APP.filteredFiles = APP.filteredFiles.filter(f => f.price >= 100000 && f.price < 200000);
    } else if (price === 'above200') {
        APP.filteredFiles = APP.filteredFiles.filter(f => f.price >= 200000);
    }
    if (sort === 'popular') {
        APP.filteredFiles.sort((a, b) => b.sold - a.sold);
    } else if (sort === 'newest') {
        APP.filteredFiles.sort((a, b) => new Date(b.date) - new Date(a.date));
    } else if (sort === 'price-low') {
        APP.filteredFiles.sort((a, b) => a.price - b.price);
    } else if (sort === 'price-high') {
        APP.filteredFiles.sort((a, b) => b.price - a.price);
    } else if (sort === 'rating') {
        APP.filteredFiles.sort((a, b) => b.rating - a.rating);
    }
...
// ====================================================
//  SHOW FILE DETAIL - HIỂN THỊ LINK TẢI KHI ĐÃ MUA
// ====================================================
function showFileDetail(file) {
    if (!file) {
        showToast('Không tìm thấy file!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    ...
    container.innerHTML = `
        <div class="file-detail-card">
            <div class="detail-header">
                ...
                <div class="info">
                    <h3>${file.name}</h3>
                    <div class="price">${file.price === 0 ? 'Miễn phí' : finalPrice.toLocaleString() + 'đ'}</div>
                    ${file.badge ? `<span class="badge-tag">${file.badge}</span>` : ''}
                </div>
            </div>
            <div class="detail-body">
                ${hasNote ? `
                    <div class="note">
                        <strong><i class="fas fa-sticky-note"></i> Ghi chú / Hướng dẫn:</strong>
                        <div style="margin-top:4px;">${file.note}</div>
                    </div>
                ` : `
                    <div class="note" style="background:rgba(255,255,255,0.02);border-color:rgba(255,255,255,0.05);">
                        <em style="color:var(--text-muted);">Không có ghi chú cho file này.</em>
                    </div>
                `}
                ${isPurchased ? `
                    <div class="download-link-box">
                        <strong><i class="fas fa-download"></i> Link tải file:</strong>
                        <a href="${downloadLink}" target="_blank">
                            ${downloadLink === '#' ? 'Liên hệ admin để lấy link tải' : downloadLink}
                        </a>
                    </div>
                ` : `
                    <div class="download-locked">
                        <i class="fas fa-lock"></i> Mua file để xem link tải
                    </div>
                `}
                <div style="margin-top:12px;display:flex;gap:10px;flex-wrap:wrap;">
                    ${!isPurchased ? `
                        <button class="btn-buy btn-buy-now" onclick="buyNow(${file.id})">
                            <i class="fas fa-bolt"></i> Mua ngay
                        </button>
                        <button class="btn-buy" onclick="${inCart ? `showToast('Đã có trong giỏ hàng!', 'fas fa-info-circle', 'warning')` : `addToCart(${file.id})`}" 
                            style="${inCart ? 'background:linear-gradient(135deg,#ffaa00,#ff6600);' : ''}">
                            <i class="fas ${inCart ? 'fa-check' : 'fa-cart-plus'}"></i> ${inCart ? 'Đã thêm giỏ' : 'Thêm giỏ'}
                        </button>
                    ` : `
                        <button class="btn-buy" onclick="switchTab('historyTab')" style="background:linear-gradient(135deg, var(--primary), var(--secondary));">
                            <i class="fas fa-clock-rotate-left"></i> Xem lịch sử
                        </button>
                    `}
                </div>
            </div>
            <div class="detail-footer">
                <span class="status"><i class="fas fa-info-circle"></i> ${isPurchased ? 'Đã mua thành công' : 'Sẵn sàng mua'}</span>
            </div>
        </div>
    `;
...
// ====================================================
//  HISTORY - HIỂN THỊ FILE ĐÃ MUA VÀ CÓ LINK TẢI
// ====================================================
function renderHistory() {
    ...
    if (history.length === 0) {
        tbody.innerHTML = `<tr><td colspan="6" style="text-align:center;color:var(--text-muted);padding:30px;">Chưa có giao dịch nào</td></tr>`;
        return;
    }
    tbody.innerHTML = history.map(h => {
        ...
        let fileId = null;
        if (isPurchase) {
            for (const f of FILE_DATA) {
                if (h.desc.includes(f.name)) {
                    fileId = f.id;
                    break;
                }
            }
        ...
        <tr>
            <td>${h.id}</td>
            <td>${h.desc}</td>
            <td style="color: ${h.amount.startsWith('+') ? '#00ff88' : '#ff4d4d'};">${h.amount}</td>
            <td><span class="status-${h.status === 'Thành công' || h.status === 'Hoàn tất' ? 'success' : 'pending'}">${h.status}</span></td>
            <td>${h.time}</td>
            <td>
                ${isPurchase && isPurchased ? `
                    <button class="btn-view-detail" onclick="showFileDetail(${fileId})" style="background:rgba(0,240,255,0.12);border:none;padding:4px 12px;border-radius:6px;color:var(--primary);cursor:pointer;">
...
// ====================================================
//  ADMIN FUNCTIONS - QUẢN LÝ FILE CÓ LINK TẢI
// ====================================================
...
function renderAdminFiles() {
    ...
    if (!container) return;
    FILE_DATA = getGlobalFiles();
    container.innerHTML = FILE_DATA.map(f => `
        <div class="admin-file-item">
            ...
            <div class="file-actions">
                <button class="btn-edit-file" onclick="adminEditFile(${f.id})"><i class="fas fa-edit"></i></button>
                <button class="btn-delete-file" onclick="adminDeleteFile(${f.id})"><i class="fas fa-trash"></i></button>
            </div>
        </div>
    `).join('');
}
...
function renderAdminDashboard() {
    ...
    if (DOM.dashTotalOrders) {
        let totalOrders = 0;
        users.forEach(u => totalOrders += (u.history || []).filter(h => h.amount.startsWith('-')).length);
        DOM.dashTotalOrders.textContent = totalOrders;
    }
    ...
    if (DOM.pendingBadge) {
        DOM.pendingBadge.textContent = stats.pendingDeposits;
        DOM.pendingBadge.className = `badge ${stats.pendingDeposits > 0 ? 'warning' : 'success'}`;
    }
    ...
    if (DOM.adminSystemTransactions) {
        let totalTx = 0;
        users.forEach(u => totalTx += (u.history || []).length);
        DOM.adminSystemTransactions.textContent = totalTx;
    }
...
function renderDepositRequests() {
    ...
    container.innerHTML = filtered.map(req => `
        <div class="deposit-request-item ${req.status === 'pending' ? 'pending-highlight' : ''}" 
             style="${req.status === 'pending' ? 'border-left: 3px solid #ffaa00;' : ''}">
            <div class="req-info">
                <div class="req-user">
                    ${req.username} 
                    <span class="req-email">(${req.userEmail || 'N/A'})</span> 
                    ${req.userVip > 0 ? `⭐ VIP ${req.userVip}` : ''}
                    ${req.status === 'pending' ? '<span style="color:#ffaa00;font-size:10px;">🟡 Mới</span>' : ''}
                </div>
                <div class="req-amount">${req.amount.toLocaleString()}đ</div>
                <div class="req-time">
                    <i class="fas fa-clock"></i> ${new Date(req.createdAt).toLocaleString('vi-VN')} 
                    | ${req.method}
                </div>
            </div>
            <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
                ...
                ` : ''}
                ${req.status === 'rejected' && req.note ? `<span style="font-size:12px;color:#ff4d4d;">Lý do: ${req.note}</span>` : ''}
            </div>
        </div>
    `).join('');
}
...
function filterDeposits(filter) {
    ...
    document.querySelectorAll('.admin-section-actions .btn-filter').forEach(btn => {
...
function approveDeposit(id) {
    ...
    Swal.fire({
        ...
        if (res.isConfirmed) {
            ...
            if (request) {
                showToast(`Đã duyệt ${request.amount.toLocaleString()}đ cho ${request.username}!`, 'fas fa-circle-check', 'success');
                triggerConfetti();
                renderAdminDashboard();
                updateRealStats();
                if (APP.currentUser && APP.currentUser.id === request.userId) {
                    APP.balance = Auth.getCurrentUser().balance;
                    APP.totalDeposit = Auth.getCurrentUser().totalDeposit;
                    APP.vipLevel = Auth.getCurrentUser().vipLevel;
                    DOM.userBalance.textContent = APP.balance.toLocaleString();
                    updateVIPUI(Auth.getCurrentUser());
                }
...
function rejectDeposit(id) {
    ...
    Swal.fire({
        ...
        if (res.isConfirmed) {
            const request = Auth.rejectDeposit(id, res.value || '');
            if (request) {
                showToast(`Đã từ chối yêu cầu của ${request.username}!`, 'fas fa-times-circle', 'error');
                renderAdminDashboard();
            }
        }
    });
...
function renderAdminUsers() {
    ...
    const users = Auth.getUsers();
    if (users.length === 0) {
        tbody.innerHTML = `<tr><td colspan="7" style="text-align:center;color:var(--text-muted);padding:30px;">Chưa có người dùng</td></tr>`;
        return;
    }
        ...
        <tr>
            ...
            <td>
                <div class="user-actions-cell">
                    <button class="btn-add-balance" onclick="adminAddBalance('${u.id}')"><i class="fas fa-plus"></i></button>
                    <button class="btn-edit-user" onclick="adminEditUser('${u.id}')"><i class="fas fa-edit"></i></button>
                    ${u.role !== 'admin' ? `<button class="btn-delete-user" onclick="adminDeleteUser('${u.id}')"><i class="fas fa-trash"></i></button>` : ''}
                </div>
            </td>
        </tr>
    `}).join('');
...
function adminAddBalance(userId) {
    Swal.fire({
        title: 'Cộng tiền cho user',
        text: 'Nhập số tiền muốn cộng (VNĐ)',
        icon: 'question',
        background: '#040814',
        color: '#fff',
        input: 'number',
    ...
    Swal.fire({
        ...
        html: `
            <div style="text-align:left;color:#fff;">
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Username</label><input id="editUsername" class="form-control" value="${user.username}" style="margin-top:4px;"></div>
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Email</label><input id="editEmail" class="form-control" value="${user.email || ''}" style="margin-top:4px;"></div>
                <div><label style="color:var(--text-muted);font-size:13px;">Vai trò</label><select id="editRole" class="form-control" style="margin-top:4px;"><option value="user" ${user.role === 'user' ? 'selected' : ''}>User</option><option value="admin" ${user.role === 'admin' ? 'selected' : ''}>Admin</option></select></div>
            </div>
        `,
        background: '#040814',
        color: '#fff',
...
function renderAdminGiftcodes() {
    ...
    if (codes.length === 0) {
        container.innerHTML = '<div style="color:var(--text-muted);padding:20px;text-align:center;">Chưa có giftcode nào</div>';
        return;
    }
    container.innerHTML = codes.map(c => `
        <div class="giftcode-item">
            <span class="code">${c.code}</span>
            <span class="value">${c.value.toLocaleString()}đ</span>
            <span class="status ${c.used ? 'used' : 'active'}">${c.used ? '✅ Đã dùng' : '🟢 Còn hiệu lực'}</span>
            <span style="font-size:12px;color:var(--text-muted);">${c.used ? 'Bởi: ' + (c.usedBy || 'N/A') : ''}</span>
            <button class="btn-delete-code" onclick="adminDeleteGiftcode('${c.code}')"><i class="fas fa-trash"></i></button>
        </div>
    `).join('');
}
...
function renderAdminEvents() {
    ...
    if (events.length === 0) {
        container.innerHTML = '<div style="color:var(--text-muted);padding:20px;text-align:center;">Chưa có sự kiện nào</div>';
        return;
    }
        ...
        <div class="admin-event-item">
            <div class="event-header">
                <div>
                    ...
                    <div class="event-detail">${e.desc} | 🎁 ${e.reward} | 📅 ${e.time}</div>
                </div>
                <div class="event-actions">
                    <span class="event-status ${e.status}">${e.status === 'active' ? '🟢 Đang diễn ra' : e.status === 'coming' ? '🟡 Sắp tới' : '🔴 Đã kết thúc'}</span>
                    <button class="btn-edit-event" onclick="adminEditEvent(${e.id})"><i class="fas fa-edit"></i></button>
                    <button class="btn-delete-event" onclick="adminDeleteEvent(${e.id})"><i class="fas fa-trash"></i></button>
                </div>
            </div>
        </div>
    `).join('');
...
function adminShowCreateEvent() {
    Swal.fire({
        ...
        html: `
            <div style="text-align:left;color:#fff;">
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Tên sự kiện</label><input id="eventName" class="form-control" placeholder="VD: Sale Cuối Tuần" style="margin-top:4px;"></div>
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Mô tả</label><input id="eventDesc" class="form-control" placeholder="VD: Giảm 20% tất cả file" style="margin-top:4px;"></div>
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Phần thưởng</label><input id="eventReward" class="form-control" placeholder="VD: Giảm 20%" style="margin-top:4px;"></div>
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Icon (emoji)</label><input id="eventIcon" class="form-control" placeholder="VD: 🎉" value="🎉" style="margin-top:4px;"></div>
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Thời gian</label><input id="eventTime" class="form-control" placeholder="VD: 01/03 - 15/03" style="margin-top:4px;"></div>
                <div><label style="color:var(--text-muted);font-size:13px;">Trạng thái</label><select id="eventStatus" class="form-control" style="margin-top:4px;"><option value="active">Đang diễn ra</option><option value="coming">Sắp tới</option><option value="ended">Đã kết thúc</option></select></div>
            </div>
        `,
        background: '#040814',
        color: '#fff',
...
function adminEditEvent(eventId) {
    ...
    Swal.fire({
        ...
        html: `
            <div style="text-align:left;color:#fff;">
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Tên sự kiện</label><input id="editEventName" class="form-control" value="${event.name}" style="margin-top:4px;"></div>
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Mô tả</label><input id="editEventDesc" class="form-control" value="${event.desc}" style="margin-top:4px;"></div>
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Phần thưởng</label><input id="editEventReward" class="form-control" value="${event.reward}" style="margin-top:4px;"></div>
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Icon</label><input id="editEventIcon" class="form-control" value="${event.icon}" style="margin-top:4px;"></div>
                <div style="margin-bottom:12px;"><label style="color:var(--text-muted);font-size:13px;">Thời gian</label><input id="editEventTime" class="form-control" value="${event.time}" style="margin-top:4px;"></div>
                <div><label style="color:var(--text-muted);font-size:13px;">Trạng thái</label><select id="editEventStatus" class="form-control" style="margin-top:4px;"><option value="active" ${event.status === 'active' ? 'selected' : ''}>Đang diễn ra</option><option value="coming" ${event.status === 'coming' ? 'selected' : ''}>Sắp tới</option><option value="ended" ${event.status === 'ended' ? 'selected' : ''}>Đã kết thúc</option></select></div>
            </div>
        `,
        background: '#040814',
        color: '#fff',
...
function switchAdminTab(tabId) {
    ...
    if (tabId === 'adminSupport') {
        updateSupportUI(getSupportLinks());
    }
    if (tabId === 'adminSettings') {
        renderAdminQRConfig();
    }
...
function renderSpinHistory() {
    ...
    if (history.length === 0) {
        container.innerHTML = '<div style="color:var(--text-muted);text-align:center;padding:10px;">Chưa có lịch sử quay</div>';
        return;
    }
    container.innerHTML = history.slice(0, 20).map(item => `
        <div class="spin-history-item">
            <span>${item.icon || '🎡'} ${item.prize}</span>
...
function spinTheWheel() {
    ...
    if (!Auth.isLoggedIn()) {
        showToast('Vui lòng đăng nhập để quay!', 'fas fa-triangle-exclamation', 'error');
        openModal('loginModal');
        return;
    }
    if (APP.isAdmin) {
        showToast('Admin không cần quay!', 'fas fa-wrench', 'warning');
        return;
    }
    if (APP.balance < 10000) {
        showToast('Số dư không đủ 10.000đ!', 'fas fa-wallet', 'error');
        switchTab('depositTab');
        return;
    }
    const user = Auth.updateBalance(Auth.getCurrentUser().id, -10000, 'Quay vòng quay');
    if (!user) return;
    APP.balance = user.balance;
    APP.history = user.history;
    DOM.userBalance.textContent = APP.balance.toLocaleString();
    ...
    setTimeout(() => {
        ...
        triggerConfetti();
        if (prize.value > 0) {
            const u2 = Auth.addDeposit(Auth.getCurrentUser().id, prize.value);
            if (u2) {
                APP.balance = u2.balance;
                APP.history = u2.history;
...
function renderEvents() {
    ...
    container.innerHTML = events.map(e => `
        <div class="event-card">
            ...
            <div class="event-reward">🎁 ${e.reward}</div>
            <div class="event-time">📅 ${e.time}</div>
            <span class="event-status ${e.status}">${e.status === 'active' ? '🟢 Đang diễn ra' : e.status === 'coming' ? '🟡 Sắp tới' : '🔴 Đã kết thúc'}</span>
            <button class="btn-join-event" ${e.status !== 'active' ? 'disabled' : ''} onclick="joinEvent(${e.id})">
                ${e.status === 'active' ? 'Tham gia ngay' : e.status === 'coming' ? 'Sắp diễn ra' : 'Đã kết thúc'}
            </button>
        </div>
    `).join('');
}
...
function joinEvent(eventId) {
    if (!Auth.isLoggedIn()) {
        showToast('Vui lòng đăng nhập để tham gia!', 'fas fa-triangle-exclamation', 'error');
        openModal('loginModal');
        return;
    }
    const event = Auth.getEvents().find(e => e.id === eventId);
    if (!event || event.status !== 'active') {
        showToast('Sự kiện không khả dụng!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
...
function renderMissions() {
    ...
    if (!missions) {
        missions = MISSIONS.map(m => ({...m, progress: 0, claimed: false}));
        ...
        return `
            <div class="mission-card">
                ...
                <div>
                    ...
                    <button class="mission-btn ${btnClass}" ${btnDisabled ? 'disabled' : ''} onclick="claimMission(${m.id})">
                        ${btnText}
                    </button>
                </div>
            </div>
...
function updateMissions(type) {
    ...
    if (mission && !mission.claimed && mission.progress < mission.total) {
        mission.progress++;
        localStorage.setItem(STORAGE_KEY_MISSIONS + today, JSON.stringify(missions));
        renderMissions();
        if (mission.progress >= mission.total) {
            showToast(`🎉 Hoàn thành nhiệm vụ: ${mission.name}!`, 'fas fa-circle-check', 'success');
        }
    }
}
...
function claimMission(missionId) {
    ...
    const mission = missions.find(m => m.id === missionId);
    if (!mission || mission.claimed || mission.progress < mission.total) {
        showToast('Chưa thể nhận thưởng!', 'fas fa-triangle-exclamation', 'error');
        return;
    }
    ...
    if (reward > 0) {
        ...
        if (user) {
            ...
            localStorage.setItem(STORAGE_KEY_MISSIONS + today, JSON.stringify(missions));
            renderMissions();
            showToast(`Nhận ${reward.toLocaleString()}đ từ nhiệm vụ!`, 'fas fa-circle-check', 'success');
            triggerConfetti();
        }
    }
}
...
function handleRedeemCode(e) {
    e.preventDefault();
    if (!Auth.isLoggedIn()) {
        showToast('Vui lòng đăng nhập để đổi giftcode!', 'fas fa-triangle-exclamation', 'error');
        openModal('loginModal');
        return;
    }
    if (APP.isAdmin) {
        showToast('Admin không cần đổi giftcode!', 'fas fa-wrench', 'warning');
        return;
    }
...
function switchTab(tabId) {
    ...
    if (tabId === 'adminTab' && APP.isAdmin) {
        renderAdminDashboard();
        setTimeout(renderAdminSpinWeights, 300);
        setTimeout(updateAdminSpinStats, 400);
        switchAdminTab(APP.adminTab || 'adminDashboard');
        updateSupportUI(getSupportLinks());
        renderAdminQRConfig();
        initSecurity();
    }
    if (tabId === 'vipTab' && APP.isLoggedIn) {
        updateVIPUI(Auth.getCurrentUser());
    }
    ...
    if (tabId === 'depositTab' || tabId === 'depositModal') {
        updateDepositUsername();
    }
...
function updateLiveUsers() {
    ...
    const variance = 40;
    setInterval(() => {
        const users = Math.floor(base + Math.random() * variance);
        if (DOM.liveUsers) DOM.liveUsers.textContent = users;
    }, 5000);
}
...
function triggerLightning() {
    lightningOverlay.style.background = 'rgba(0, 240, 255, 0.4)';
    bgContainer.style.filter = 'contrast(1.4) saturate(1.5) brightness(1.25)';
    setTimeout(() => {
        lightningOverlay.style.background = 'rgba(255, 255, 255, 0)';
        bgContainer.style.filter = 'contrast(1.3) saturate(1.45) brightness(1.1)';
    }, 70);
    setTimeout(triggerLightning, Math.random() * 12000 + 5000);
}
...
function triggerConfetti() {
    confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ['#00f0ff', '#7000ff', '#ff0077', '#00ff88', '#ffaa00']
    });
    setTimeout(() => {
        confetti({ particleCount: 50, spread: 40, origin: { y: 0.5, x: 0.3 }, colors: ['#00f0ff', '#ffffff'] });
        confetti({ particleCount: 50, spread: 40, origin: { y: 0.5, x: 0.7 }, colors: ['#00ff88', '#7000ff'] });
    }, 200);
}
...
function toggleMusic() {
    ...
    if (isPlaying) {
        ...
        musicStatus.textContent = trackList[currentTrack] + ' 🔥';
        showToast('🎧 Đang phát nhạc!', 'fas fa-music');
    } else {
        playBtn.className = 'fas fa-play';
        musicStatus.textContent = trackList[currentTrack] + ' ⏸️';
        showToast('Đã dừng nhạc', 'fas fa-pause');
    }
}

function nextTrack() {
    currentTrack = (currentTrack + 1) % trackList.length;
    musicStatus.textContent = trackList[currentTrack] + (isPlaying ? ' 🔥' : ' ⏸️');
    if (isPlaying) showToast(`Bài: ${trackList[currentTrack]}`, 'fas fa-forward');
}

function prevTrack() {
    currentTrack = (currentTrack - 1 + trackList.length) % trackList.length;
    musicStatus.textContent = trackList[currentTrack] + (isPlaying ? ' 🔥' : ' ⏸️');
    if (isPlaying) showToast(`Bài: ${trackList[currentTrack]}`, 'fas fa-backward');
}
...
console.log('🏦 QR: Ảnh QR code đã được hỗ trợ');
console.log('🛡️ Security: Active (IP Block DISABLED)');
console.log('🔥 Mọi hệ thống đã sẵn sàng!');